...
struct Renderer : NonAssignable
{
    ...
    void drawTextureSection(SDL_Texture* texture, const SDL_Rect& srcRect, const SDL_Rect& dstRect,
    ...
    void drawTexture(SDL_Texture* texture, const SDL_Rect& dstRect,
                     const float angle = 0, const SDL_Point* center = NULL,
                     const SDL_RendererFlip flip = SDL_FLIP_NONE) noexcept
    {
    ...
    void drawTexture(SDL_Texture* texture, Vector2f pos,
