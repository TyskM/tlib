...
SFMLBox2DDebugDraw::SFMLBox2DDebugDraw(sf::RenderWindow &window) : m_window(&window) {}
...
void SFMLBox2DDebugDraw::DrawCircle(const b2Vec2& center, float radius, const b2Color& color) 
{
...
void SFMLBox2DDebugDraw::DrawSolidCircle(const b2Vec2& center, float radius, const b2Vec2& axis, const b2Color& color) 
{
	sf::CircleShape circle(radius * scale);
	circle.setOrigin(radius * scale, radius * scale);
	circle.setPosition(SFMLBox2DDebugDraw::B2VecToSFVec(center));
