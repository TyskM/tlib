...
bool ImGui_ImplSDL2_ProcessEvent(const SDL_Event* event)
{
    ...
    {
        //float realx, realy;
        //SDL_RenderWindowToLogical(bd->Renderer, 0, 0, &realx, &realy);
        //std::cout << realx << ", " << realy << std::endl;
        //io.AddMousePosEvent(event->motion.x - realx, event->motion.y - realy);
...
static void ImGui_ImplSDL2_UpdateMouseData()
{
    ...
    if (is_app_focused)
    {
        ...
        //{
        //    int window_x, window_y, mouse_x_global, mouse_y_global, logicalx, logicaly;
        //    SDL_GetGlobalMouseState(&mouse_x_global, &mouse_y_global);
        //    SDL_GetWindowPosition(bd->Window, &window_x, &window_y);
        //    SDL_RenderGetLogicalSize(bd->Renderer, &logicalx, &logicaly);
