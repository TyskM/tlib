...
namespace eastl
{
    ...
    public:
        ...
        void flip();
        void set();
        void set(word_type i, bool value);
        void reset();
        ...
        word_type& DoGetWord(word_type i);
        word_type  DoGetWord(word_type i) const;
    ...
    public:
        ...
        word_type& DoGetWord(word_type);
        word_type  DoGetWord(word_type) const;
    ...
    public:
        ...
        static_assert(!is_const_v<WordType>      , "WordType cant be const.");
        static_assert(!is_volatile_v<WordType>   , "WordType cant be volatile.");
        static_assert(!is_same_v<WordType, bool> , "WordType cant be bool.");

        // Just work for enums please god
        // static_assert(is_integral_v<WordType> ||
        //               std::is_enum_v<WordType> && std::is_integral_v<std::underlying_type<WordType>>,
        //               "WordType must be integral.");
        // static_assert(is_unsigned_v<WordType> ||
        //               std::is_enum_v<WordType> && std::is_unsigned_v<std::underlying_type<WordType>>,
        //               "WordType must be unsigned.");
    ...
    public:
        ...
        this_type& set();
        this_type& set(word_type i, bool value = true);
    ...
    template <size_t NW, typename WordType>
    inline void BitsetBase<NW, WordType>::set(word_type i, bool value)
    {
        if(value)
    ...
    BitsetBase<NW, WordType>::DoGetWord(word_type i)
    {
    ...
    template <size_t NW, typename WordType>
    inline typename BitsetBase<NW, WordType>::word_type
    BitsetBase<NW, WordType>::DoGetWord(word_type i) const
    {
        return mWord[i >> kBitsPerWordShift];
    }
...
EA_RESTORE_GCC_WARNING()
    ...
    template <typename WordType>
    inline void BitsetBase<1, WordType>::set(word_type i, bool value)
    {
        if(value)
    ...
    {
        mWord[0] = static_cast<WordType>(0);
    }
    ...
    BitsetBase<1, WordType>::DoGetWord(word_type)
    {
        return mWord[0];
    }
    ...
    template <typename WordType>
    inline typename BitsetBase<1, WordType>::word_type
    BitsetBase<1, WordType>::DoGetWord(word_type) const
    {
        return mWord[0];
    }
    ...
    template <typename WordType>
    inline void BitsetBase<2, WordType>::set(word_type i, bool value)
    {
        if(value)
            mWord[i >> kBitsPerWordShift] |=  (static_cast<word_type>(1) << (i & kBitsPerWordMask));
        else
    ...
    BitsetBase<2, WordType>::DoGetWord(word_type i)
    {
        return mWord[i >> kBitsPerWordShift];
    }
    ...
    template <typename WordType>
    inline typename BitsetBase<2, WordType>::word_type
    BitsetBase<2, WordType>::DoGetWord(word_type i) const
    {
        return mWord[i >> kBitsPerWordShift];
    }
    ...
    template <size_t N, typename WordType>
    inline typename bitset<N, WordType>::this_type&
    bitset<N, WordType>::set(word_type i, bool value)
    {
        if(i < N)
    ...
    template <size_t N, typename WordType>
    inline bool bitset<N, WordType>::test(word_type i) const
    {
        if(EASTL_UNLIKELY(i < N))
            return (DoGetWord(i) & (static_cast<word_type>(1) << (i & kBitsPerWordMask))) != 0;
