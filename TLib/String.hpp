...
namespace strhelp
{
    ...
    static inline Vector<StrT> split(StrT src, const StrT& delimiter)
    {
        Vector<StrT> ret;
        size_t pos = 0;
        StrT token;
    ...
    template <typename StrT>
    static inline StrT toLower(StrT str)
    {
    ...
    template <typename StrT>
    static inline String toUpper(StrT str)
    {
    ...
    template <typename StrT>
    static inline bool endswith(const StrT& str, const StrT& ending)
    {
    ...
    template <typename StrT>
    static inline bool endswith(const StrT& str, const std::initializer_list<StrT> endings)
    {
        bool r = true;
    ...
    template <typename StrT>
    static inline bool beginswith(const StrT& str, const StrT& beginning)
    {
    ...
    template <typename StrT>
    static inline bool beginswith(const StrT& str, const std::initializer_list<StrT> beginnings)
    {
        bool r = true;
    ...
    template <typename StrT>
    static inline bool replaceFirst(StrT& str, const StrT& from, const StrT& to)
    {
    ...
    template <typename StrT>
    static inline void replace(StrT& str, const StrT& from, const StrT& to)
    {
    ...
    static inline String floatToStr(float v, size_t precision)
    {
        std::stringstream ss;
    ...
    static inline bool compareIgnoreCase(const String& first, const String& second)
